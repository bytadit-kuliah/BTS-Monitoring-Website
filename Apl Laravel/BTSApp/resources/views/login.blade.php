                ...
                <form class="card_login">
                    <div class="box_input box_input_username">
                        ...
                        <div class="input_field">
                            <input type="text" id="input_username" name="input_username" placeholder="masukkan username...">
                        </div>
                    </div>
                    <div class="box_input box_input_password">
                        <label for="input_password">Password :</label>
                        <div class="input_field">
                            <input type="password" id="input_password" name="input_password" placeholder="masukkan password...">
