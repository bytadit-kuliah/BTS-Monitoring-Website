...
<head>
    ...
    <title>Edit Profil - BTS Surveyor</title>
            ...
            <div class="row">
              <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                  <img class="rounded-circle mt-5" src="https://www.bls.gov/ooh/images/1856.jpg" style="height: 400px"/><span class="font-weight-bold">Paijo</span>
                  <span class="text-black-50">iniemail@gmail.com</span><span> </span>
                </div>
              </div>
