            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">pesan yang dikirim melalui halaman visitor:</li>
                    </ol>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card mb-4 bg-bts-3 text-white">
                                ...
                                <div class="card-footer small ">received today at 1:59 AM</div>
                                <div class="card-body bg-light text-black ">
                                    <h5>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque aut porro ipsam error dolorum nostrum fugiat natus labore similique sed, eius provident reprehenderit id, quas consequuntur dolores eligendi nihil, harum aperiam! Molestias enim eius molestiae asperiores amet quae praesentium eveniet.
                                    </h5>
                                </div>
                                <div class="card-footer small ">received today at 0:59 PM</div>
                                <div class="card-body bg-light text-black ">
                                    <h5>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita dignissimos omnis culpa reiciendis tempore obcaecati ut perferendis, minima ad quo provident asperiores unde sit alias, sed molestias quae harum fugiat? Id labore minus inventore dolorem necessitatibus nostrum obcaecati vero. Voluptates reprehenderit impedit nihil odio magni asperiores ea nostrum voluptatibus sit, perspiciatis quos nemo suscipit veniam et, aspernatur alias cupiditate nesciunt? Deleniti in assumenda voluptatem!
                                    </h5>
                                </div>
                                <div class="card-footer small ">received yesterday at 7:59 PM</div>
                                <div class="card-body bg-light text-black ">
                                    <h5>
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi labore, officiis quibusdam consectetur quasi nostrum, iusto mollitia odit distinctio illum sapiente tempora sint blanditiis ex, illo hic consequatur minima. Debitis?
                                    </h5>
                                </div>
                                <div class="card-footer small ">received yesterday at 4:59 PM</div>
                            </div>
                        </div>
                    </div>
                </div>
